...
try {
    ...
    startState.preload = function () {
        ...
        if (!hasLoaded) {
            ...
            game.load.image(
                "scale9White",
                "assets/images/Scale9_WhiteRounded_01.png"
            );
            game.load.image(
                "tutorial1",
                "assets/images/Tutorial_Runner_01.jpg"
            );
            game.load.image(
                "tutorial2",
                "assets/images/Tutorial_Runner_02.jpg"
            );
            game.load.image(
                "tutorial3",
                "assets/images/Tutorial_Runner_03.jpg"
            );
            ...
            game.load.image(
                "bgSpeedStars",
                "assets/images/Bg_Stars_Blurred.png"
            );
            ...
            game.load.image(
                "scoreContainer",
                "assets/images/GS_END_container.png"
            );
            game.load.image(
                "topScoresContainer",
            ...
            game.load.audio(
                "music",
                "js/mod/575279_Praise-The-Sun-420Yolo.mp3"
            );
